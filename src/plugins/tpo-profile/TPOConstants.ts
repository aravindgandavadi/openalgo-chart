...
export interface TPOGradient {
    start: string;
    end: string;
}

export interface TPOGradients {
    upper: TPOGradient;
    lower: TPOGradient;
}

export interface TPOLineColors {
    poc: string;
    vah: string;
    val: string;
    poorHigh: string;
...
export interface TPOOptionsColors extends TPOLineColors {
    upperGradient: TPOGradient;
    lowerGradient: TPOGradient;
}
...
export interface TPOOptions {
    ...
    // Colors
    colors: TPOOptionsColors;
}

export type BlockSizeKey = '5m' | '10m' | '15m' | '30m' | '1h' | '2h' | '4h';

export type LetterColorMap = Record<string, string>;

// ==================== CONSTANTS ====================

// Block size options (TPO period duration)
export const BLOCK_SIZE_MAP: Record<BlockSizeKey, number> = {
    '5m': 5,
    '10m': 10,
    '15m': 15,
    '30m': 30,   // Default
...
export const BLOCK_SIZE_OPTIONS: string[] = Object.keys(BLOCK_SIZE_MAP);
export const DEFAULT_BLOCK_SIZE: BlockSizeKey = '30m';
...
export const TPO_GRADIENTS: TPOGradients = {
    upper: {
...
const generateLetterColors = (): LetterColorMap => {
    const colors: LetterColorMap = {};
...
export const LETTER_COLORS: LetterColorMap = generateLetterColors();
...
export const TPO_LINE_COLORS: TPOLineColors = {
...
export const AVAILABLE_STATS: string[] = [
    'VAH',
    'VAL',
    'POC',
    'Rotation factor',
