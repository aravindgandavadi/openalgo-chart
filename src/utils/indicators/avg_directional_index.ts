...
export interface ADXResult {
    adx: TimeValuePoint[];
    plusDI: TimeValuePoint[];
    minusDI: TimeValuePoint[];
}
 ...
 * @returns ADXResult with adx, plusDI, and minusDI arrays
 */
export function calculateADX(data: OHLCData[], period: number = 14): ADXResult {
    ...
    const plusDI: TimeValuePoint[] = [];
    const minusDI: TimeValuePoint[] = [];
    const adx: TimeValuePoint[] = [];
